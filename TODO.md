...
- [ ] support table syntax in preview
- [ ] add README.txt documenting steps to install this app, and local UTF-8 file persistence, launch restore, atomic autosave/import behavior, protocol-based architecture, and current synchronous un-debounced silent-error limitation.
